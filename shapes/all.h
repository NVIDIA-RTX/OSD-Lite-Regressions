...
constexpr int const kCatmarkStart = __LINE__;
...
constexpr int const kCatmarkEnd = __LINE__;
constexpr int const kNumCatmarkShapes = kCatmarkEnd - (kCatmarkStart + 1);

constexpr int const kBilinearStart = __LINE__;
#include "bilinear_cube.h"
#include "bilinear_nonplanar.h"
#include "bilinear_nonquads0.h"
#include "bilinear_nonquads1.h"
constexpr int const kBilinearEnd = __LINE__;
constexpr int const kNumBilinearShapes = kBilinearEnd - (kBilinearStart + 1);

constexpr int const kLoopStart = __LINE__;
...
constexpr int const kLoopEnd = __LINE__;
constexpr int const kNumLoopShapes = kLoopEnd - (kLoopStart + 1);
